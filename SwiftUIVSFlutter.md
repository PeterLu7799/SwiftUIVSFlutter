...
代码复杂度，可以看出Flutter的代码量和复杂度要高于SwiftUI，这个由于SwiftUI是苹果设计的运行在自己的系统上的框架，它可以很深度的优化，再加上苹果一贯的简约风格和简化开发者的理念造成了SwiftUI的代码量和复杂度都比Flutter低，但是这就造成了定制性不强。相反Flutter是开源的可修改定制的地方就多。
